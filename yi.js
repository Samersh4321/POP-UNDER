function jq_show2() {
    ...
    script1.onload = script1.onreadystatechange = function () {
        if (!done1 && (!this.readyState || this.readyState === "loaded" || this.readyState === "complete")) {
            ...
            script2.text = 'yXpop.Cookie.remove(\'yXpop0\'); yXpop.add(\'//deloplen.com/afu.php?zoneid=2770767', {under: true, newTab: false, width: yx_w, height: yx_h, top: yx_t, left: yx_l });';
